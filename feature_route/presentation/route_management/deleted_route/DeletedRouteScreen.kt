package com.polygonbikes.ebike.v3.feature_route.presentation.route_management.deleted_route
...
fun DeletedRouteLayout(
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(state.listDeletedRoute) { route ->
                RouteManagementCard(
                    detail = route,
                    onOpenDetailRoute = onOpenDetailRoute,
                    isDeleted = true,
                    isRouteLoading = state.isDeletedRouteLoading,
                    onActionRoute = onRestoreRoute,
                )
            }
